...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyNodeCreation = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreation-BTSTPHHD.js").then((n) => n.N), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyNodeDetailsView = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeDetailsView-CCBO4utA.js"), true ? __vite__mapDeps([5,1,2,6,7,8,9,10,11,12,13,14,3,15,16,17]) : void 0)
    );
    const LazySetupWorkflowCredentialsButton = defineAsyncComponent(
      async () => await __vitePreload(() => import("./SetupWorkflowCredentialsButton-BpHc5I9I.js"), true ? __vite__mapDeps([18,1,2]) : void 0)
    );
    const $style = useCssModule();
