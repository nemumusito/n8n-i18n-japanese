const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-IasCR2bT.js","assets/index-LGUZBtYa.js","assets/index-sq5ggyEC.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-DrgwFS0W.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, as as useNDVStore, r as ref, hz as useElementSize, q as computed, dW as executionDataToJson, i as createElementBlock, g as openBlock, e as createBlock, j as createVNode, w as withCtx, f as createCommentVNode, m as unref, c2 as defineAsyncComponent, c1 as Suspense, hu as TextWithHighlights, n as normalizeClass, hv as MappingPill, h2 as Draggable, ao as __vitePreload, v as shorten, hy as getMappedExpression, hA as isString, hB as nonExistingJsonPath, aP as useExternalHooks, ag as useTelemetry, _ as _export_sfc } from "./index-LGUZBtYa.js";
import { m as VueJsonPretty } from "./RunData-Bb8R6DnX.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-IasCR2bT.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
