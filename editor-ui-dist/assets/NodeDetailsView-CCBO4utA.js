import { d as defineComponent, r as ref, q as computed, h as resolveComponent, i as createElementBlock, g as openBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, bC as _sfc_main$g, w as withCtx, bd as withKeys, b2 as withModifiers, l as createTextVNode, t as toDisplayString, m as unref, c as useI18n, e as createBlock, f as createCommentVNode, z as nextTick, _ as _export_sfc, as as useNDVStore, Q as useWorkflowsStore, dG as isCommunityPackageName, cO as NPM_PACKAGE_DOCS_BASE_URL, h_ as BUILTIN_NODES_DOCS_URL, cQ as COMMUNITY_NODES_INSTALLATION_DOCS_URL, aP as useExternalHooks, ag as useTelemetry, bm as NodeConnectionTypes, b as useRouter, bf as useClipboard, a5 as useWorkflowHelpers, a as useToast, h$ as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, i0 as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, fE as MCP_TRIGGER_NODE_TYPE, fm as FORM_TRIGGER_NODE_TYPE, bk as CHAT_TRIGGER_NODE_TYPE, X as watch, F as Fragment, D as renderList, aQ as onClickOutside, aq as h, i1 as toRef, i2 as tryOnScopeDispose, i3 as toValue, i4 as isIOS, i5 as noop, i6 as isObject, i7 as isClient, bz as useNodeTypesStore, bA as useNodeHelpers, G as useDebounce, B as normalizeStyle, gl as TitledList, bw as getNodeInputs, i8 as SWITCH_NODE_TYPE, eq as isEqual, i9 as captureException, p as useSettingsStore, au as usePostHog, bS as useCredentialsStore, u as useUsersStore, a1 as useProjectsStore, dL as OPEN_AI_API_CREDENTIAL_TYPE, ia as AI_CREDITS_EXPERIMENT, bV as useHistoryStore, ab as ProjectTypes, bx as getConnectionTypes, o as onMounted, bI as ndvEventBus, y as onBeforeUnmount, ib as _sfc_main$h, ic as CUSTOM_NODES_DOCS_URL, aA as withDirectives, aB as vShow, hA as _sfc_main$i, id as NodeCredentials, bo as get, fV as getNodeParameters, cn as deepCopy, ie as set, ig as unset, fK as RenameNodeCommand, hz as isINodePropertyCollectionList, ih as isINodePropertiesList, ii as isINodePropertyOptionsList, ij as displayParameter, hf as Draggable, bN as useThrottleFn, H as useUIStore, fZ as useSlots, ik as MAIN_NODE_PANEL_WIDTH, aJ as useStorage, il as LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH, x as renderSlot, co as resolveDirective, ds as InfoTip, cT as storeToRefs, gp as useNodeDirtiness, e0 as useNodeType, bq as usePinnedData, gm as CanvasNodeDirtiness, aV as createSlots, be as N8nText, im as waitingNodeTooltip, bH as N8nRadioButtons, el as isPresent, io as truncate, h4 as createStaticVNode, bZ as START_NODE_TYPE, fj as MANUAL_TRIGGER_NODE_TYPE, ip as CRON_NODE_TYPE, iq as INTERVAL_NODE_TYPE, by as getNodeOutputs, ir as uniqBy, b6 as resolveDynamicComponent, aR as N8nTooltip, bE as N8nIcon, is as isTriggerPanelObject, dB as getTriggerNodeServiceName, fd as WEBHOOK_NODE_TYPE, dv as CopyInput, C as createEventBus, go as Transition, V as VIEWS, ak as WORKFLOW_SETTINGS_MODAL_KEY, ge as useDeviceSupport, it as EXECUTABLE_TRIGGER_NODE_TYPES, ay as STICKY_NODE_TYPE, iu as BASE_NODE_SURVEY_URL, aa as EnterpriseEditionFeature, e7 as dataPinningEventBus, bK as useStyles, iv as APP_MODALS_ELEMENT_ID, ai as useMessage, aj as MODAL_CONFIRM, c0 as jsonParse } from "./index-2X4RXSdq.js";
import { i as importCurlEventBus } from "./import-curl-BAfCsXB9.js";
import { R as RunData } from "./RunData-__nE0Zjf.js";
import { b as convertToDisplayDateComponents } from "./dateFormatter-ClUs7OAW.js";
import { R as RunDataAi } from "./RunDataAi-CtfjIbnj.js";
import { u as useWorkflowActivate } from "./useWorkflowActivate-DR0OS4C-.js";
import "./FileSaver.min-Cu8e9kEJ.js";
import "./useExecutionHelpers-D-fGmVHp.js";
import "./RunDataParsedAiContent-BZxNTpp6.js";
      ...
      return names.map((name) => {
        ...
        if (node2) {
          ...
          if (matchedNodeType) {
            ...
            const stringifiedIssues = issues ? nodeHelpers.nodeIssuesToString(issues, node2) : "";
...
const NodeSettings = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__cssModules", cssModules$9], ["__scopeId", "data-v-a3c6ba66"]]);
