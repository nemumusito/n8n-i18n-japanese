...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-DVC5qNW-.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-CiJArwWo.js"), true ? __vite__mapDeps([6,1,2,7,3,4,8]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-LGUZBtYa.js").then((n) => n.iA), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-BcFHbDRQ.js"), true ? __vite__mapDeps([9,1,2,10]) : void 0)
    );
    const props = __props;
    const emit = __emit;
