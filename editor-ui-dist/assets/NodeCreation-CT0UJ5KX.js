const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-B4pqPTNp.js","assets/index-LGUZBtYa.js","assets/index-sq5ggyEC.css","assets/useCanvasOperations-D9yzH8Pf.js","assets/NodeCreator-D9fmPdS2.css"])))=>i.map(i=>d[i]);
import { bz as useNodeTypesStore, q as computed, c as useI18n, Q as useWorkflowsStore, fh as MANUAL_TRIGGER_NODE_TYPE, hC as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bm as NodeConnectionTypes, bk as CHAT_TRIGGER_NODE_TYPE, hD as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, hE as OPEN_AI_NODE_TYPE, f9 as SPLIT_IN_BATCHES_NODE_TYPE, hF as NO_OP_NODE_TYPE, fc as WEBHOOK_NODE_TYPE, fj as SCHEDULE_TRIGGER_NODE_TYPE, aP as useExternalHooks, $ as useCanvasStore, eD as AI_CATEGORY_LANGUAGE_MODELS, hG as QA_CHAIN_NODE_TYPE, hH as AGENT_NODE_TYPE, hI as BASIC_CHAIN_NODE_TYPE, hJ as OPEN_AI_ASSISTANT_NODE_TYPE, ay as STICKY_NODE_TYPE, ff as TRIGGER_NODE_CREATOR_VIEW, c9 as NODE_CREATOR_OPEN_SOURCES, d as defineComponent, H as useUIStore, r as ref, bM as useThrottleFn, o as onMounted, y as onBeforeUnmount, h as resolveComponent, i as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, w as withCtx, m as unref, bP as KeyboardShortcutTooltip, c2 as defineAsyncComponent, c1 as Suspense, F as Fragment, ao as __vitePreload, hK as getMidCanvasPosition, hL as DEFAULT_STICKY_WIDTH, hM as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-LGUZBtYa.js";
import { a as useNodeCreatorStore, t as transformNodeType, s as sortNodeCreateElements } from "./useCanvasOperations-D9yzH8Pf.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-B4pqPTNp.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
    const emit = __emit;
