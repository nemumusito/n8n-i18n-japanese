const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-D-HLuPBK.js","assets/index-LGUZBtYa.js","assets/index-sq5ggyEC.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-CuuYUZbH.js","assets/chartjs.utils-C2OJmalA.js","assets/InsightsSummary-BgEN9Ee_.js","assets/InsightsSummary-CdlaUpAt.css","assets/index-CO1lozy7.js","assets/InsightsChartFailed-DXHiR3Zf.js","assets/InsightsChartFailureRate-C38KofZG.js","assets/InsightsChartTimeSaved-BmNq_ywG.js","assets/InsightsChartAverageRuntime-B13ThEHt.js","assets/InsightsTableWorkflows-Cps5msj9.js","assets/InsightsTableWorkflows-Blv_GPUj.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, g9 as useModel, g_ as useInsightsStore, r as ref, hj as UNLICENSED_TIME_RANGE, h4 as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, i as createElementBlock, F as Fragment, D as renderList, m as unref, e7 as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, k as createBaseVNode, e8 as N8nSelect, q as computed, c as useI18n, j as createVNode, be as N8nText, bg as N8nButton, hk as ElDialog, a6 as usePageRedirectionHelper, _ as _export_sfc, c2 as defineAsyncComponent, X as watch, h as resolveComponent, n as normalizeClass, b6 as resolveDynamicComponent, ao as __vitePreload, ag as useTelemetry, hl as TELEMETRY_TIME_RANGE } from "./index-LGUZBtYa.js";
import { I as InsightsSummary } from "./InsightsSummary-BgEN9Ee_.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-D-HLuPBK.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-CuuYUZbH.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-DXHiR3Zf.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-C38KofZG.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-BmNq_ywG.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-B13ThEHt.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-Cps5msj9.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
