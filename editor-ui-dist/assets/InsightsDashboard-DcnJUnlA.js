const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-lalmwUWe.js","assets/index-2X4RXSdq.js","assets/index-yNaoC3fo.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-D-HK-ZQk.js","assets/chartjs.utils-DLzITVvF.js","assets/InsightsSummary-CQHHgA8t.js","assets/InsightsSummary-CdlaUpAt.css","assets/index-BscK6-bT.js","assets/InsightsChartFailed-BPYKed8N.js","assets/InsightsChartFailureRate-C4nJugcc.js","assets/InsightsChartTimeSaved-CJ713gC5.js","assets/InsightsChartAverageRuntime-DZxpn2Ec.js","assets/InsightsTableWorkflows-Cx2mLucJ.js","assets/InsightsTableWorkflows-Blv_GPUj.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, gk as useModel, hb as useInsightsStore, r as ref, hw as UNLICENSED_TIME_RANGE, hi as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, i as createElementBlock, F as Fragment, D as renderList, m as unref, ee as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, k as createBaseVNode, ef as N8nSelect, q as computed, c as useI18n, j as createVNode, be as N8nText, bg as N8nButton, hx as ElDialog, a6 as usePageRedirectionHelper, _ as _export_sfc, c5 as defineAsyncComponent, X as watch, h as resolveComponent, n as normalizeClass, b6 as resolveDynamicComponent, ao as __vitePreload, ag as useTelemetry, hy as TELEMETRY_TIME_RANGE } from "./index-2X4RXSdq.js";
import { I as InsightsSummary } from "./InsightsSummary-CQHHgA8t.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const InsightsUpgradeModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-481d45c1"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-lalmwUWe.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-D-HK-ZQk.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-BPYKed8N.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-C4nJugcc.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-CJ713gC5.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-DZxpn2Ec.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-Cx2mLucJ.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
